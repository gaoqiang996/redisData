...
public class RedisUtil {
    ...
    public List<String> getKeys(String key) {
        Set<String> keys =  isBlank(key) ? null : redisTemplate.keys(key);
    ...
    public List<Map<String,String>> getVals(String key) {
        Set<String> keys =  isBlank(key) ? null : redisTemplate.keys(key);
        ...
        if (keys == null) {
            ...
            for (String k : keys) {
                ...
                map.put(k,(String)redisTemplate.opsForValue().get(k));
                vals.add(map);
            }
            return vals;
        }
